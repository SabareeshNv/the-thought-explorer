---
title: "14 Architectural Design Ideas for a Spacious Cities"
...
<BlogPostImage src="/images/post/sun.webp" alt="man dancing on sunrise" />
...
<div class="bg-accent text-gray-900 p-6 text-center shadow rounded-md full-bleed">
    <p>Tiam, ad mint andaepu dandae nostion secatur sequo quae.  
    **Note** that you can use _Markdown syntax_ within a blockquote.</p>
</div>
